...
module.exports = {
  ...
  // the directories in which you have .password set. Check the documentation for details. //文件夹下有子文件夹需要再加斜杠/
  protectedRoutes: ['/图片/private', '/人工智能/PrivateReport','/网课/private','/毕业设计云存档/private','/数字图像处理笔记/private'],
